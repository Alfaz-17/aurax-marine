  ...
  return (
    <div className="space-y-12">
      <div className="flex items-center justify-between border-b border-border pb-8">
        <div>
          <h1 className="text-3xl font-bold text-secondary uppercase tracking-tighter">Inventory Console</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-8 border border-border">
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-secondary uppercase tracking-widest block">Search Matrix</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-secondary uppercase tracking-widest block">Sector Filter</label>
            <select
      ...
      <div className="bg-white border border-border overflow-hidden shadow-2xl">
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-secondary text-white text-[10px] font-bold uppercase tracking-widest">
                ...
                <tr key={product._id} className="hover:bg-muted/30 transition-colors">
                  <td className="py-6 px-6">
                    <div className="flex items-center gap-6">
                       ...
                       <div>
                          <h4 className="font-bold text-secondary uppercase tracking-tight text-sm mb-1">{product.title}</h4>
                          <p className="text-[10px] text-muted-foreground line-clamp-1 italic">{product.description}</p>
                       </div>
                    </div>
                  </td>
                  <td className="py-6 px-6">
                    <span className="px-3 py-1 bg-accent/10 border border-accent/20 text-secondary text-[9px] font-extrabold uppercase tracking-widest">

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-secondary uppercase tracking-wider">Orders</h1>
                ...
                <div key={order._id} className="bg-white border border-border p-6">
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h3 className="text-lg font-bold text-secondary mb-2">{order.customerName}</h3>
                      ...
                      <div className="border-t border-border pt-4">
                        ...
                        {order.items.map((item, idx) => (
                          <div key={idx} className="flex items-center justify-between py-2 border-b border-border last:border-0">
                            <span className="text-sm font-medium text-secondary">{item.productTitle}</span>

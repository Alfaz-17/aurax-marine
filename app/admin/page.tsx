  ...
  return (
    <div className="space-y-12">
      <div className="flex justify-between items-end border-b border-border pb-8">
        <div>
          <h1 className="text-3xl font-bold text-secondary uppercase tracking-tighter">Command Center</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {cards.map((card, index) => (
          ...
          >
            ...
            <dd className="text-4xl font-extrabold text-secondary tracking-tighter">{card.value}</dd>
      ...
      <div className="grid lg:grid-cols-2 gap-8 mt-12">
        <div className="bg-secondary p-10 text-white relative h-64 flex flex-col justify-center">

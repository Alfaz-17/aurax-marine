  ...
  return (
    <div className="space-y-12">
      <div className="flex items-center justify-between border-b border-border pb-8">
        <div>
          <h1 className="text-3xl font-bold text-secondary uppercase tracking-tighter">Intel & Briefing</h1>
         ...
         {filteredBlogs.map((blog, idx) => (
            <div key={blog._id} className="bg-white border border-border flex flex-col group h-full">
               ...
               <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                     <h3 className="text-lg font-bold text-secondary uppercase tracking-tight mb-4 group-hover:text-accent transition-colors line-clamp-2">{blog.title}</h3>

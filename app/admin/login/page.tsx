...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-secondary flex items-center justify-center p-6 bg-[url('/assets/hero-bg.jpg')] bg-cover bg-center">
        ...
        <div className="bg-white p-10 border border-white/10 shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-secondary uppercase tracking-widest">Operator Email</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-secondary uppercase tracking-widest">Access Key</label>
              <div className="relative">
                <input
          ...
          <div className="mt-8 pt-8 border-t border-border text-center">
             <Link href="/" className="text-[10px] font-extrabold uppercase tracking-widest text-secondary hover:text-accent transition-colors">Abort Access & Return Home</Link>
          </div>
        </div>
      </motion.div>
    </div>

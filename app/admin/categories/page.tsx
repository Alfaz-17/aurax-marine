  ...
  return (
    <div className="max-w-4xl space-y-12">
      <div className="border-b border-border pb-8">
        <h1 className="text-3xl font-bold text-secondary uppercase tracking-tighter">Sector Management</h1>
      ...
      <div className="bg-white p-10 border border-border">
         <h2 className="text-sm font-bold uppercase tracking-widest text-secondary mb-8">Register New Sector</h2>
                     ...
                     <td className="py-6 px-8">
                        <div className="flex items-center gap-4">
                           ...
                           {editingId === cat._id ? (
                              ...
                              <span className="text-sm font-bold text-secondary uppercase tracking-tight">{cat.name}</span>
                           )}
                        </div>
                     </td>

...
export async function sendInquiryEmail(data: InquiryEmailData) {
  ...
  try {
    ...
    const { data: resendData, error } = await resend.emails.send({
      from: 'Spice Ship Supplier <onboarding@resend.dev>', // Update this after domain verification
      to: process.env.EMAIL_TO || 'spiceshipsupplier@gmail.com',
      ...
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; text-align: left;">
          ...
          <p style="font-size: 12px; color: #777;">This email was automatically generated by the Spice Ship Supplier website.</p>
        </div>
      `,
    });
...
export async function sendContactEmail(data: ContactEmailData) {
  ...
  try {
    ...
    const { data: resendData, error } = await resend.emails.send({
      from: 'Spice Ship Supplier Contact <onboarding@resend.dev>', // Update this after domain verification
      to: process.env.EMAIL_TO || 'spiceshipsupplier@gmail.com',

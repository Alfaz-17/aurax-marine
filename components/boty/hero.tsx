      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-6 sm:py-8 md:pt-10">
        <div className="max-w-4xl">
           ...
           >
              ...
              <Link
                href="/contact"
                className="px-5 sm:px-6 py-3 border border-black/30 text-black font-black uppercase tracking-widest text-[9px] sm:text-[10px] hover:bg-black hover:text-white transition-all flex items-center justify-center gap-3"
              >

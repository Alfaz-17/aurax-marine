...
export function StatsSection() {
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-secondary relative overflow-hidden border-y border-muted/10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 lg:gap-24">
          {stats.map((stat, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-white flex items-center justify-center mx-auto mb-4 sm:mb-6 md:mb-8 transition-transform group-hover:scale-110 shadow-2xl border border-primary/20">
                 <stat.icon className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-secondary" />
              </div>
